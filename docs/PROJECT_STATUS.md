...
- [ ] **Phase E — Engine: selection-aware bonus capacity & sequencing**
      ...
      Unlocks Southwest Companion Pass use case.
...
- [ ] **Phase H — Roadmap display polish** Table sorting on profile
      card-list, responsive multi-column grid for recommendation tiles,
      bonus multiplier badges (5x gas, etc.), network icon sprites
      (Visa/MC/Amex) instead of colored squares.
