...
// Card Ownership Modal Functionality
async function openCardOwnershipModal(cardId, existingUserCard = null, cardType = 'personal') {
    ...
    // Phase K: owner selector — mirrors base.html's edit-card modal. Only
    // shown for authed households with more than one entity of THIS card's
    // own kind; otherwise the backend auto-assigns by card_type on add
    // (see _resolve_owner_entity), so there's nothing to pick.
